...
<body>
	...
	<div id="back"><br/>
	<center>
	<form method="post" autocomplete="off" onsubmit="return checkPassword()" action="registerstf.php">
		<fieldset>
		<br/>
		<h3>Staff Registration Form </h3></br>
		
		<p style="color:red;"><?php echo $_SESSION['error']."<br/>";?></p>
		<label for="fname">First Name : </label>
		<input type="text" id="fname" name="stfname" value="<?php if(isset($_POST['stfname'])){ echo $_POST['stfname'];}?>" required><br/><br/>
		
		<label for="lname">Last Name : </label>
		<input type="text" id="lname" name="stlname" required><br/><br/>
		...
		<label for="repwd" required>Confirm Password : </label>
		...
		<input type="submit" id="sbmt" name="sbmt" value="Register as staff" disabled><br/><br/>
	Already a member? 
